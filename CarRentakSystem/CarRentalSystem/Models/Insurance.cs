...
// =====================================================================
// INSURANCE MODULE - Car Rental System
// Matches the actual Insurance model provided (Insurance_ID, PolicyType,
// Coverage, Premium, Rental_ID -> Rental).
//
// PART 1: Insurance.cs            -> /Models   (your existing model, unchanged)
// PART 2: InsuranceDTOs.cs        -> /DTOs
// PART 3: InsuranceController.cs  -> /Controllers
//
// Rename namespaces below only if your project uses different ones.
// Assumed: CarRentalSystem.Data.CarRentalSystemContext with:
//   DbSet<Insurance> Insurances { get; set; }
//   DbSet<Rental> Rentals { get; set; }
// Assumed Rental model has a primary key named Rental_ID.
// =====================================================================


// =====================================================================
// PART 1: Models/Insurance.cs  (your model, kept as-is for reference)
// =====================================================================
using System.ComponentModel.DataAnnotations;
using System.ComponentModel.DataAnnotations.Schema;
using Microsoft.EntityFrameworkCore;
...
// =====================================================================
// PART 2: DTOs/InsuranceDTOs.cs
// =====================================================================
using System.ComponentModel.DataAnnotations;

namespace CarRentalSystem.DTOs
{
    // Used when creating a new insurance policy
    ...
    // Used for a full update of PolicyType / Coverage / Premium
    ...
    // Second, distinct update case: reassign the policy to a different
    // rental (update via the related entity's FK)
    public class InsuranceRentalReassignDto
    {
        [Required]
        public int Rental_ID { get; set; }
    }
